...
int main(int argc, char **agrv)
{
    ...
    printf(" %i=unidades", entrada%BASE);//para obtener el primer valor,calculamos el modulo 10 del valor suponiendo que es de 3 digitos
    ...
    printf(" %i=decenas",resultado%BASE);//con ese ultimo valor realizamos el modulo nuevamente para obtener el valor de las decenas
